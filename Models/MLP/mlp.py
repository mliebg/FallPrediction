...
# Defining the model
def make_MLP_model(input_shape):
    """
    Defining the model
    ...
    h1 = keras.layers.Dense(32, activation='relu')(input_layer)
    h2 = keras.layers.Dense(32, activation='relu')(h1)

    output_layer = keras.layers.Dense(num_classes, activation='softmax')(h2)

    return keras.models.Model(inputs=input_layer, outputs=output_layer)


#model = make_MLP_model(input_shape=X_train_tensor.shape[1:])
